...
class App:
    def __init__(self):
        ...
        self.matchers = ['-FC-', '-FCFC-', '-FCFCFC-', '-FCFCFCFC-','-FCTI-','-FCTIAL-','-FCTIFC-','-FCTIFCAL-','-FCTIALAL-']  # Variable a escoger
    ...
    def part_window(self):
        ...
        # Nombre de la parte
        self.entry4 = tk.Button(self.entryframe, text='empty', bg='white', bd=0, width=22, anchor='w',font=('Arial', '18')) # PARTE
        ...
        self.button10 = ttk.Button(self.entryframe, text='Delete Entry', command=lambda: self.delete_entry(),style='AccentButton')
